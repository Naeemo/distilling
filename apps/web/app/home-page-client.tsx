        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { title: '智能采集', description: '粘贴链接自动抓取，支持网页、RSS等多种来源', icon: '📥' },
                { title: 'AI摘要', description: '一键生成快速或详细摘要，节省阅读时间', icon: '🤖' },
                { title: '高亮笔记', description: '边读边标注，支持多色高亮和添加笔记', icon: '📝' },
                { title: '间隔重复', description: '科学复习算法，帮助知识长期记忆', icon: '🧠' },
              ].map((feature) => (
                <div
                  key={feature.title}
